...
public abstract class BaseService<E extends BaseEntity, A extends BaseDTO, D extends JpaRepository<E, Long>> {
    ...
    public List<A> findAll() {
        logProducer.sendLog(new LogDTO(
                "findAll method called for " + persistantClass.getSimpleName()));
    ...
    public A save(A dto) {
        ...
        logProducer.sendLog(new LogDTO("save method called for " + persistantClass.getSimpleName()
    ...
    public void deleteById(Long id) {
        logProducer.sendLog(new LogDTO("deleteById method called for " + persistantClass.getSimpleName()
                + " with id: " + id));
        dao.deleteById(id);
    }
    ...
    public A findByIdWithControl(Long id) {
        ...
        logProducer.sendLog(new LogDTO("findByIdWithControl method called for "
                + persistantClass.getSimpleName() + " with id: " + id));
        return Mapper.map(entity, dtoClass);
    }
